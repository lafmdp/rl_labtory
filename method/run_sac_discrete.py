...
import numpy as np
import gym
from functions.sac_discrete import policy, ReplayBuffer
...
parser.add_argument('--env', default="Boxing-ram-v0", type=str)
...
if __name__ == "__main__":
    ...
    buffer = ReplayBuffer(obs_dim, act_dim, size=1000000)
    ...
    return_list = []
    import datetime
    writer = SummaryWriter("./tbfile/{}-{}".format("sac-discrete", datetime.datetime.now().strftime('%Y-%m-%d%H:%M:%S')))
